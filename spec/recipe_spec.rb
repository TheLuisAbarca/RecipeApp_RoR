...
RSpec.describe "Recipe page", type: :feature do
    ...
    it "should be able to see save recipe and click on the recently recipe and enter to recipe details" do
        ...
        fill_in 'Description', with: 'Pizza is a savory dish of Italian origin, consisting of a usually round, flattened base of leavened wheat-based dough topped with tomatoes, cheese, and often various other ingredients (anchovies, olives, meat, etc.)'
